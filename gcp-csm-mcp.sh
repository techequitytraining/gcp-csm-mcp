...
export ISTIO_VERSION=1.23.2 # https://github.com/istio/istio/releases
export ASM_VERSION=1.23.2-asm.2 # https://cloud.google.com/service-mesh/docs/release-notes
