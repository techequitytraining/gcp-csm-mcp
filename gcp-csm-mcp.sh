...
export ISTIO_VERSION=1.23.4 # 1.22.3 # https://github.com/istio/istio/releases
export ASM_VERSION=1.23.4-asm.1 # 1.22.3-asm.1 # 1.23.2-asm.2 not working # https://cloud.google.com/service-mesh/docs/release-notes
export ASM_INSTALL_SCRIPT_VERSION=1.23 # 1.22
EOF
source $PROJDIR/.env
fi
